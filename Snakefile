# Authors: Benjamin Skov Kaas-Hansen (creator, maintainer)
# Contributors: Cristina Leal Rodríguez, Davide Placido, Hans-Christian Thorsen-Meyer
...
module load intel/perflibs/64/2017_update3 intel/redist/2017.2.174 
module unload R
module load R/3.4.0
""")
...
rule optimise_hyperparameters: 
	...
	resources: vmem = 1024*250, tmin = 60*12
	threads: 5
...
rule train_explain_final_models: 
	...
	params: dbname = "bth", dbuser = "benkaa", dbschema = "hidosfaikid", weights_dir = "data/04-weights",
		#n_shap_background = 5000, #n_explanations = 10
...
rule figure2_bivariate_shap_figure:
	...
	params: dbname = "bth", dbuser = "benkaa", dbschema = "hidosfaikid", unit = "cm", height = 25, width = 29,
...
rule optuna_learning:
	...
	params: dbname = "bth", dbuser = "benkaa", dbschema = "hidosfaikid", unit = "cm", height = 18, width = 28
	resources: vmem = 1024*2, tmin = 15
...
rule performance_figures:
	...
	params: dbname = "bth", dbuser = "benkaa", dbschema = "hidosfaikid", unit = "cm", height = 10, width = 28
...
rule shap_figure:
	...
	params: dbname = "bth", dbuser = "benkaa", dbschema = "hidosfaikid", unit = "cm", height = 28, width = 18
	resources: vmem = 1024, tmin = 5
