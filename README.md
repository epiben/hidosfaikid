...
**Repo contributors**: [Benjamin Skov Kaas-Hansen](http://github.com/epiben) [code author], [Cristina Rodriguez Leal](http://github.com/crlero) [code review], Davide Placido [code review], Hans-Christian Thorsen-Meyer [code review]
